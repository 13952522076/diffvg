...
for t in range(100):
    ...
    pydiffvg.imwrite(img.cpu(), 'results/single_gradient2/iter_{}.png'.format(t), gamma=2.2)
    pydiffvg.save_svg('results/single_gradient2/iter_{}.svg'.format(t), canvas_width, canvas_height, shapes, shape_groups)
