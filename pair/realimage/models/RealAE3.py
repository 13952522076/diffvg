...
if __name__ == '__main__':
    ...
    model = RealAE3(imsize=224, paths=512, segments=3, samples=2, zdim=2048, pretained_encoder=True)
    model.to("cuda")
    out = model(img)
