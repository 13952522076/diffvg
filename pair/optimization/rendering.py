...
def main(args):
    ...
    points_optim = torch.optim.SGD(points_vars, lr=0.1, momentum=0.9, weight_decay=1e-4)
    color_optim = torch.optim.SGD(color_vars, lr=0.01, momentum=0.9, weight_decay=1e-4)
    # Adam iterations.
