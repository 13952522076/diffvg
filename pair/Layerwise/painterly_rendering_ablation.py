...
def main(args):
    ...
    img = render(canvas_width, # width
                 ...
                 None,
                 *scene_args)
    pydiffvg.imwrite(img.cpu(), f'results/painterly_rendering/{args.save_folder}/init.png', gamma=gamma)
    ...
    for t in range(args.num_iter):
        ...
        pydiffvg.imwrite(img.cpu(), f'results/painterly_rendering/{args.save_folder}/iter_{t}.png', gamma=gamma)
        img = img[:, :, :3]
        ...
        if t % 10 == 0 or t == args.num_iter - 1:
            pydiffvg.save_svg(f'results/painterly_rendering/{args.save_folder}/iter_{t}.svg',
                              canvas_width, canvas_height, shapes, shape_groups)
